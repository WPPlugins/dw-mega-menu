<div class="modal-box-icon">
	<div class="modal-header">
		<h1><?php _e( 'Select Icon', 'dw-megamenu' ); ?></h1>
		<span>
	...
	<div class="modal-content">
		...
		<div class="menu-icon-wrap">
			...
			<!-- label class="menu-icon-style">
				<input type="radio" name="menu_item_icon_show" value="fa fa-bed" />
				<i class="fa fa-bed" data-filter="web_app"></i>
			</label>

			<label class="menu-icon-style">
				<input type="radio" name="menu_item_icon_show" value="fa fa-archive" />
				<i class="fa fa-archive" data-filter="web_app"></i>
			</label>

			<label class="menu-icon-style">
				<input type="radio" name="menu_item_icon_show" value="fa fa-camera" />
				<i class="fa fa-camera" data-filter="web_app"></i>
			</label>

			<label class="menu-icon-style">
				<input type="radio" name="menu_item_icon_show" value="fa fa-car" />
				<i class="fa fa-car" data-filter="web_app"></i>
			</label>

			<label class="menu-icon-style">
				<input type="radio" name="menu_item_icon_show" value="fa fa-desktop" />
				<i class="fa fa-desktop" data-filter="web_app"></i>
			</label>

			<label class="menu-icon-style">
				<input type="radio" name="menu_item_icon_show" value="fa fa-filter" />
				<i class="fa fa-filter" data-filter="web_app"></i>
			</label>

			<label class="menu-icon-style">
				<input type="radio" name="menu_item_icon_show" value="fa fa-laptop" />
				<i class="fa fa-laptop" data-filter="web_app"></i>
			</label>

			<label class="menu-icon-style">
				<input type="radio" name="menu_item_icon_show" value="fa fa-pencil" />
				<i class="fa fa-pencil" data-filter="web_app"></i>
			</label>

			<label class="menu-icon-style">
				<input type="radio" name="menu_item_icon_show" value="fa fa-file" />
				<i class="fa fa-file" data-filter="file_type"></i>
			</label>

			<label class="menu-icon-style">
				<input type="radio" name="menu_item_icon_show" value="fa fa-cog" />
				<i class="fa fa-cog" data-filter="spinner"></i>
			</label>

			<label class="menu-icon-style">
				<input type="radio" name="menu_item_icon_show" value="fa fa-cc-visa" />
				<i class="fa fa-cc-visa" data-filter="payment"></i>
			</label>

			<label class="menu-icon-style">
				<input type="radio" name="menu_item_icon_show" value="fa fa-paypal" />
				<i class="fa fa-paypal" data-filter="payment"></i>
			</label> -->
	...
	<div class="modal-footer">
		<button id="button_select_icon" class="button button-primary"><?php _e( 'Select', 'dw-megamenu' ); ?></button>
	</div>
</div>
